...
class ChatbotService:
    ...
    def _create_rag_chain(self):
        ...
        # Sử dụng RetrievalQA (tương đương create_retrieval_chain)
    ...
    def get_response(self, user_question: str) -> str:
        ...
        try:
            response = self.rag_chain({"query": user_question})
            answer = response.get("result", "Xin lỗi, tôi không thể tìm thấy câu trả lời.")
